...
export function Hero() {
  return (
    <div className="bg-secondary-500 relative overflow-hidden mt-[60px] old-lg:mt-[76px] font-karla pb-20 xl:pb-0">
      ...
      <div className="w-full xl:max-w-[840px] mx-auto mt-10">
        ...
        <div className="relative px-5">
          ...
          />
          <button className="bg-secondary-500 absolute top-[18%] xl:right-14 right-1 px-3 py-1.5 rounded-full border-neutral-200 border-4 border-solid">
            Coming Soon
          </button>
        </div>
      </div>
