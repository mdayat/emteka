...
export default function RoadMapPage() {
  ...
  return (
    <>
      ...
      <main className="y-[75px] mx-auto w-full xl:w-3/4 font-karla px-4 xl:px-0">
        <section className="flex flex-col gap-y-4 text-center mt-[150px] mx-auto xl:w-[738px] mb-8 px-4 xl:px-0">
